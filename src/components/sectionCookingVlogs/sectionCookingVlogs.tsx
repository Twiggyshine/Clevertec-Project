...
import { culinaryBlogsData } from '../../data/culinaryBlogsData';
import CulinaryBlogCard from '../sectionCookingVlogs/cookingVlogsCard';
...
const CulinaryBlogsSection = () => (
    <Box maxWidth='1360px' h='304px' bg='#c4ff61' mb='40px' borderRadius='16px' p='24px'>
        ...
        <Grid templateColumns={{ base: '1fr', md: 'repeat(3, 1fr)' }} gap='16px'>
            {culinaryBlogsData.map((author) => (
                <GridItem key={author.id} borderRadius='8px'>
