...
const Banner = () => {
    const { avatar, name, email, followers } = userRecipe.user;
    return (
        <HStack w='100%' h='144px' backgroundColor='#c4ff61' borderRadius='8px' p='24px' mb='40px'>
            <Image src={avatar} alt='Аватар' w='96px' h='96px' objectFit='contain' />
            <Box flex='1' ml='24px'>
                <Flex justifyContent='space-between' alignItems='center' w='100%'>
                    <Text fontWeight='700' fontSize='20px' whiteSpace='nowrap'>
                        {name}
                    </Text>
                    <Text fontWeight='400' fontSize='14px' whiteSpace='nowrap'>
                        Автор рецепта
                    </Text>
                </Flex>
                <Box fontWeight='400' fontSize='14px' color='rgba(0, 0, 0, 0.64)' mt='8px'>
                    {email}
                </Box>
