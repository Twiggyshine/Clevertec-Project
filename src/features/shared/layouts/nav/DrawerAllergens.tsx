...
const DrawerAllergens = ({
    ...
    const [selectedCategories, clearSelectedCategories] = useState<string[]>([]);
    const [selectedAuthors, clearSelectedAuthors] = useState<string[]>([]);
    const [selectedMeats, clearSelectedMeats] = useState<string[]>([]);
    const [selectedSides, clearSelectedSides] = useState<string[]>([]);
                    ...
                    <DrawerBody>
                        <VStack spacing={6} align='stretch'>
                            <BaseSelect
                                ...
                                options={['Категория 1', 'Категория 2', 'Категория 3']}
                                value={selectedCategories}
                                onChange={clearSelectedCategories}
                            />
                            ...
                            <Box>
                                ...
                                <CheckboxGroup
                                    value={selectedMeats}
                                    onChange={(values) => clearSelectedMeats(values as string[])}
                                >
                                    <VStack align='start' spacing={2}>
                                        <StyledCheckbox value='chicken'>Курица</StyledCheckbox>
                                        <StyledCheckbox value='pork'>Свинина</StyledCheckbox>
                            ...
                            <Box>
                                ...
                                <CheckboxGroup
                                    value={selectedSides}
                                    onChange={(values) => clearSelectedSides(values as string[])}
                                >
                                    <VStack align='start' spacing={2}>
                                        <StyledCheckbox value='potato'>Картошка</StyledCheckbox>
                                        <StyledCheckbox value='buckwheat'>Гречка</StyledCheckbox>
